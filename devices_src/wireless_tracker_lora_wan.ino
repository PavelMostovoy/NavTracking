...
// /* OTAA para*/
// uint8_t devEui[] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x06, 0x53, 0xC7 };
// uint8_t appEui[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
// uint8_t appKey[] = { 0x72, 0xD6, 0x6E, 0x63, 0x45, 0x82, 0x48, 0x27, 0xFE, 0xC5, 0xB7, 0x70, 0xBA, 0x2B, 0x50, 0x43 };

// /* ABP para*/
// uint8_t nwkSKey[] = { 0x15, 0xb1, 0xd0, 0xef, 0xa4, 0x63, 0xdf, 0xbe, 0x3d, 0x11, 0x18, 0x1e, 0x1e, 0xc7, 0xda, 0x84 };
// uint8_t appSKey[] = { 0xd7, 0x2c, 0x78, 0x75, 0x8c, 0xdc, 0xca, 0xbf, 0x55, 0xee, 0x4a, 0x77, 0x8d, 0x16, 0xef, 0x68 };
// uint32_t devAddr = (uint32_t)0x007e6ae2;

/* OTAA params first device */
...
void loop() {
  switch (deviceState) {
    case DEVICE_STATE_INIT:
      {
        ...
        //both set join DR and DR when ADR off 0-5  0-max distance 5- max speed
    ...
    case DEVICE_STATE_SLEEP:
      {
        st7735.st7735_write_str(0, 0, "FRAxxxx");
